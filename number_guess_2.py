"""
The name of this game is Number Guess 2. This version will include a replay option.
...
Otherwise, the computer wins. This version includes a replay option.
''')
